...
namespace MyCompany.Data
{
    ...
    public class BusinessRulesBase : ActionHandlerBase, MyCompany.Data.IRowHandler, MyCompany.Data.IDataFilter, MyCompany.Data.IDataFilter2
    {
        ...
        {
            UpdateFieldValue(name, value, false);
        }

        public void UpdateFieldValue(string name, object value, bool addMissingFieldValue)
        {
            if (DBNull.Value.Equals(value))
                value = null;
            if ((_page != null) && (_row != null))
            ...
            else
            {
                ...
                if (Arguments != null)
                {
                    ...
                    if ((v == null) && addMissingFieldValue)
                    {
                        v = new FieldValue(name);
                        AddFieldValue(v);
                    }
                    if (v != null)
                    {
