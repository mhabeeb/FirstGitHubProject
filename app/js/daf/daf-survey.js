...
(function () {
    ...
    _app.survey = function (method, options) {
        ...
        function showCompiled(survey) {
            ...
            if (!survey.cancelText)
                survey.cancelText = options.cancelText;
            if (!survey.init)
            ...
            if (sharedInstance) {
                ...
                if (sharedDataView && sharedDataView._survey && sharedDataView._survey.sharedInstance === sharedInstance) {
                    ...
                    survey.compiled = function (result) {
                        ...
                        sharedDataView._editRow = null; // reset the edit row
        ...
        function compile() {
            ...
            if (options.cancel != false)
                result.ActionGroups[0].Actions.push({ Id: 'a2', CommandName: 'Cancel', WhenLastCommandName: 'New', HeaderText: options.cancelText });
